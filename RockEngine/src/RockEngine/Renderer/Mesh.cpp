...
namespace RockEngine
{
		...
		: m_FilePath(filename)
	{
		...
		m_MeshShader = m_IsAnimated ? Renderer::GetShaderLibrary()->Get("ShaderPBRAnim.glsl") : Renderer::GetShaderLibrary()->Get("ShaderPBR.glsl");
	...
	{
		RE_CORE_ASSERT(pNodeAnim->mNumPositionKeys > 0, "");
	...
	{
		RE_CORE_ASSERT(pNodeAnim->mNumRotationKeys > 0, "");
	...
	{
		RE_CORE_ASSERT(pNodeAnim->mNumScalingKeys > 0, "");
	...
	glm::vec3 Mesh::InterpolateTranslation(float animationTime, const aiNodeAnim* nodeAnim)
	{
		...
		RE_CORE_ASSERT(NextPositionIndex < nodeAnim->mNumPositionKeys, "");
		float DeltaTime = (float)(nodeAnim->mPositionKeys[NextPositionIndex].mTime - nodeAnim->mPositionKeys[PositionIndex].mTime);
		float Factor = (animationTime - (float)nodeAnim->mPositionKeys[PositionIndex].mTime) / DeltaTime;
		RE_CORE_ASSERT(Factor <= 1.0f, "Factor must be below 1.0f");
	...
	glm::quat Mesh::InterpolateRotation(float animationTime, const aiNodeAnim* nodeAnim)
	{
		...
		RE_CORE_ASSERT(NextRotationIndex < nodeAnim->mNumRotationKeys, "");
	...
	glm::vec3 Mesh::InterpolateScale(float animationTime, const aiNodeAnim* nodeAnim)
	{
		...
		RE_CORE_ASSERT(nextIndex < nodeAnim->mNumScalingKeys, "");
